...
public class Photo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("Anlık Photo");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnimg = getView().findViewById(R.id.btnGetimg);
        final ImageView mImageView = getView().findViewById(R.id.imageview2);
        ...
        btnimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(), "Butona Tıklandı", Toast.LENGTH_SHORT).show();
